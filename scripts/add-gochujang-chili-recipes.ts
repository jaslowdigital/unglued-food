...
const gochujangChiliRecipes = [
  {
    ...
    longDescription: "This dairy-free gluten-free creamy white chicken chili combines the best of Korean and Southwestern flavors. Rich coconut milk creates an ultra-creamy base while gluten-free gochujang adds bold, spicy Korean heat. Tender chicken pieces and white beans simmer in a velvety coconut broth infused with cumin and smoked paprika. The result is a fusion comfort bowl that's both comforting and exciting — perfect for those avoiding gluten and dairy without sacrificing flavor. Top with fresh cilantro, coconut cream drizzle, and lime for a restaurant-quality meal that comes together in under an hour.",
  ...
  },
  {
    ...
    longDescription: "Sweet corn kernels and bright lime juice create the perfect balance against spicy gochujang in this gluten-free white chicken chili. The natural sweetness of corn complements the creamy coconut or dairy base, while lime adds refreshing tang that cuts through the rich heat. Tender chicken thighs and white beans make this a protein-packed meal that's both satisfying and vibrant. This fusion bowl brings together the best of Korean spice and Southwestern comfort, creating layers of flavor in every spoonful. Perfect for weeknight dinners or meal prep — it only gets better the next day!",
  ...
  },
  {
    ...
    longDescription: "This Korean fusion masterpiece tops creamy gochujang white chicken chili with crunchy, tangy kimchi for an explosion of flavors and textures. The creamy coconut or dairy base is infused with sesame oil, ginger, and gluten-free gochujang, creating a rich foundation. White beans and tender chicken add protein and heartiness, while the kimchi garnish brings probiotic benefits, crunch, and bold Korean flavor. Scallions and sesame seeds complete this restaurant-worthy bowl. It's comfort food that's both familiar and adventurous — perfect for those who love bold, spicy, fermented flavors.",
  ...
  },
  {
    ...
    longDescription: "Smoky roasted poblano and red bell peppers transform this creamy gochujang white chicken chili into a deeply layered, complex comfort bowl. The peppers are charred under the broiler until blistered, then peeled and diced, adding smoky sweetness that complements the spicy gochujang heat. Combined with tender chicken, white beans, and a creamy sour cream or Greek yogurt base, this chili offers incredible depth of flavor. Smoked paprika and cumin enhance the Southwestern-Korean fusion while fresh cilantro and cream drizzle finish each bowl beautifully. It's sophisticated comfort food at its finest.",
  ...
  },
  {
    ...
    longDescription: "Cool, tangy Greek yogurt creates the perfect counterbalance to spicy gochujang in this protein-packed white chicken chili. The yogurt is stirred in at the end to maintain its creamy texture and probiotic benefits, creating a luscious, balanced bowl. Fresh cilantro adds bright herbal notes while lime juice provides acidity that brightens all the flavors. Tender chicken, white beans, cumin, and coriander round out this fusion comfort food that's both healthful and indulgent. It's an easy weeknight meal that delivers restaurant-quality flavor with minimal effort.",
  ...
  },
  {
    ...
    longDescription: "Crispy bacon brings smoky, salty richness to this creamy gochujang white chicken chili, creating layers of savory depth. The bacon is cooked first, and its rendered fat is used to brown the chicken, infusing every bite with smoky flavor. White beans, heavy cream, and gochujang create the creamy, spicy base, while fresh scallions add crunch and brightness. Smoked paprika enhances the bacon's smokiness, making this a bold, indulgent fusion comfort bowl. Top with extra crispy bacon and scallions for the perfect combination of textures and flavors.",
  ...
  },
  {
    ...
    longDescription: "Cubed sweet potatoes add natural sweetness and heartiness to this creamy gochujang white chicken chili, making it the ultimate cold-weather comfort food. The sweet potatoes simmer until tender, their natural sugars caramelizing slightly and balancing the spicy gochujang heat. A touch of cinnamon enhances their sweetness while cumin adds earthy warmth. Coconut cream or dairy creates a velvety base for tender chicken and white beans. This fusion bowl is both nutritious and satisfying — perfect for meal prep or feeding a crowd on chilly evenings.",
  ...
  },
  {
    ...
    longDescription: "Aromatic lemongrass and fresh ginger bring bright Southeast Asian flavors to this creamy gochujang white chicken chili. The lemongrass is bruised and simmered to release its citrusy aroma, while ginger adds warming, spicy notes. Coconut milk creates a rich, dairy-free base, and gluten-free fish sauce adds umami depth. White beans and tender chicken make this a protein-rich meal with complex, layered flavors. It's an adventurous fusion bowl that combines Korean heat with Southeast Asian aromatics — perfect for those who love bold, aromatic comfort food.",
  ...
  },
  {
    ...
    longDescription: "Smooth, cooling avocado lime crema tops this spicy creamy gochujang white chicken chili, creating the perfect balance of heat and cool. The crema is blended with ripe avocados, lime juice, Greek yogurt, and cilantro until silky smooth. Below, tender chicken and white beans simmer in a creamy, gochujang-spiced broth that delivers bold Korean heat. The contrast between the spicy chili and cooling crema creates restaurant-quality flavor and visual appeal. It's an elegant fusion bowl that's both comforting and sophisticated.",
  ...
  },
  {
    ...
    longDescription: "This hearty, meal-style chili combines tender chicken, mixed beans, and nutty brown rice in a creamy gochujang sauce for a protein-packed complete meal. Three types of beans — white, kidney, and pinto — add varied textures and fiber, while brown rice makes it extra filling. The creamy base is infused with smoked paprika and cumin, creating Southwestern-Korean fusion flavors. This is comfort food that satisfies and fuels — perfect for meal prep, feeding a crowd, or anyone who wants a hearty bowl that keeps them full for hours.",
